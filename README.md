...
### 3.1. Phương thức truy xuất dữ liệu hệ thống (Metrics/Incidents)
...
### 3.2. Chiến lược xử lý nạp dữ liệu và truy xuất RAG (Data Ingestion & Retrieval)
...
### 3.3. Chiến lược quản lý Context & Memory
